...
This project directory focuses on developing an AirBnB clone using a web framework. It involves creating a functional web application using Python, with a back-end powered by Flask, a lightweight web server. This clone will mimic the core features of AirBnB, providing a platform for users to list, browse, and book accommodations. The project aims to demonstrate proficiency in back-end development and web server management.
...
**File:** [0-hello_route.py](0-hello_route.py), [__init__.py](__init__.py)
...
**File:** [web_flask/7-states_list.py](web_flask/7-states_list.py), [web_flask/templates/7-states_list.html](web_flask/templates/7-states_list.html)
...
**File:** [web_flask/8-cities_by_states.py](web_flask/8-cities_by_states.py), [web_flask/templates/8-cities_by_states.html](web_flask/templates/8-cities_by_states.html)
...
**File:** [web_flask/9-states.py](web_flask/9-states.py), [web_flask/templates/9-states.html](web_flask/templates/9-states.html)
...
* After each request you must remove the current SQLAlchemy Session:
   ...
   - Call in this method `storage.close()`
* Routes:
   - `/hbnb_filters`: display a HTML page like `6-index.html`, which was done during the project [0x01. AirBnB clone - Web static](https://github.com/deezyfg/AirBnB_clone/tree/master/web_static)
...
**File:** [web_flask/10-hbnb_filters.py](web_flask/10-hbnb_filters.py), [web_flask/templates/10-hbnb_filters.html](web_flask/templates/10-hbnb_filters.html), [web_flask/static/]([web_flask/static/)
...
* After each request you must remove the current SQLAlchemy Session:
   ...
   - Call in this method `storage.close()`
* Routes:
   - `/hbnb`: display a HTML page like 8-index.html, done during the [0x01. AirBnB clone - Web static](https://github.com/deezyfg/AirBnB_clone/tree/master/web_static) project
...
![Image 1](https://i.postimg.cc/SQTgvDrj/image1.png)
![Image 2](https://i.postimg.cc/xTX6DMx5/image2.png)
![Image 3](https://i.postimg.cc/hv5MQtjV/image3.png)
