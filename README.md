...
6. [GitHub](#github)
7. [Outlined Project Tasks](#outlined_project_tasks)
8. [Structured Overview of Repository Contents](#structured-overview-of-repository-contents)
10. [Authors](#authors)
...
This project focuses on developing an AirBnB clone using MySQL for data storage. It involves creating a robust back-end with Python, utilizing Object-Oriented Programming (OOP) principles. The project integrates SQL for database management and employs SQLAlchemy as an Object-Relational Mapping (ORM) tool to interact with the MySQL database efficiently.
...
For this project you will fork this [codebase](https://github.com/justinmajetich/AirBnB_clone/tree/master):
...
**File:** [setup_mysql_dev.sql](setup_mysql_dev.sql)
...
**File:** [setup_mysql_test.sql](setup_mysql_test.sql)
...
![Project image](https://i.postimg.cc/fyxfrwpp/Screenshot-from-2024-04-12-17-22-15.png)
...
**Files:**
- [models/review.py](models/review.py)
- [models/user.py](models/user.py)
- [models/place.py](models/place.py)
...
**Files:**
- [models/amenity.py](models/amenity.py)
- [models/place.py](models/place.py)
...
This project focuses on deploying a static version of the AirBnB clone. It involves applying DevOps practices, using Python for scripting, and managing system administration tasks. The project also incorporates Continuous Integration and Continuous Deployment (CI/CD) techniques to automate and streamline the deployment process.
...
<details>
  <summary><a href="#ci/cd"><strong>CI/CD</strong></a></summary><br>

  <!-- Image 1 -->
  <div align="center">
    <a href='https://postimages.org/' target='_blank'>
      <img src='https://i.postimg.cc/rm3x5f4P/image1.png' border='0' alt='image' style="max-width: 100%;">
    </a>
  </div>
  ...
  <div align="center">
    <a href='https://postimages.org/' target='_blank'>
      <img src='https://i.postimg.cc/xCcLkwXm/image2.png' border='0' alt='image' style="max-width: 100%;">
    </a>
  </div>
  ...
  <ul>
    <li><strong>Links from screenshot</strong>
      <ul>
        <li><a href="https://agilemanifesto.org/principles.html" title="Twelve Principles of Agile Software">Twelve Principles of Agile Software</a></li>
        <li><a href="https://digital.ai/catalyst-blog/walk-before-you-run-understanding-ci-in-cd/" title="CI/CD">CI/CD</a></li>
      </ul>
    </li>
  </ul>
</details>
...
Ever since you completed project [0x0F. Load balancer](https://github.com/deezyfg/alx-system_engineering-devops/tree/master/0x0F-load_balancer) of the SysAdmin track, you’ve had 2 web servers + 1 load balancer but nothing to distribute with them.
...
<p align="center">
  <img src="https://s3.amazonaws.com/intranet-projects-files/holbertonschool-higher-level_programming+/288/aribnb_diagram_0.jpg"/>
</p>
...
* [Difference between root and alias on NGINX](https://github.com/esfand/printit/blob/master/nginx-alias.md)
...
For a list of contributors to this project, please refer to the [AUTHORS](https://github.com/deezyfg/AirBnB_clone_v2/blob/master/AUTHORS) file.